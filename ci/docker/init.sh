...
docker compose exec -T gateway bash -c '
  ...
  cp /var/www/html/config/openconext/parameters.yaml.dist /var/www/html/config/legacy/parameters.yaml && \
  cp /var/www/html/config/openconext/samlstepupproviders_parameters.yaml.dist /var/www/html/config/legacy/samlstepupproviders_parameters.yaml && \
  cp /var/www/html/config/openconext/global_view_parameters.yaml.dist /var/www/html/config/legacy/global_view_parameters.yaml && \
